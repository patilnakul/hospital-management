    ...
    <div class="row">
        <div class="col-md-4 offset-md-4">
            <div class="card paint-card">
                <div class="card-body">
                    <p class="fs-4 fw-bold text-center text">Edit Doctor Details</p>
                    <c:if test="${not empty errorMsg}">
                        <p class="fs-6 text-center text-danger">${errorMsg}</p>
                        <c:remove var="errorMsg" scope="session"/>
                    </c:if>
                    <c:if test="${not empty succMsg}">
                        <div class="fs-6 text-center fw-bold text-success" role="alert">${succMsg}</div>
                   ...
                   Doctor d= dao2.getDoctorById(id);
                    ...
                    <form action="../updateDoctor" method="post">
                        ...
                        <button type="submit" class="btn text-center btn-success col-md-12">Update</button>
                    </form>
                </div>
            </div>
         </div>
